...
public class PanAndZoom : MonoBehaviour {
    ...
    Vector3 screenTouch = screenCenter + new Vector3(deltaPosition.x, deltaPosition.y, 0f);
    ...
    Vector3 worldTouchPosition = cam.ScreenToWorldPoint(screenTouch);
        ...
        // Set the Y component of worldDeltaPosition to 0
        ...
        // Set the camera's rotation to zero rotation (aligned with world axes)
        cam.transform.rotation = Quaternion.Euler(0, originalRotation.eulerAngles.y, 0);
worldDeltaPosition *= 10;
        // Translate the camera
        cam.transform.Translate(-worldDeltaPosition);
